...
//TARIQ EDIT; run "nodejs pokedex.js" to export the javascript variables as a JSON file
//Afterwards, use https://jsonlint.com to make it look pretty (and validate the file)
var MYJSON = JSON.stringify(BattlePokedex);

var fs = require('fs');
fs.writeFile("from_js_pokedex.json", MYJSON, function(err) {
	if(err){
		console.log(err)
	}
});
